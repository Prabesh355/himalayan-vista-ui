              ...
              <div className="grid gap-2">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <textarea
                    ...
                    className="min-h-48 w-full rounded-md border border-input bg-background px-3 py-2 text-sm font-mono"
                    placeholder={
                ...
                {formErrors.itinerary && (
                  <p className="text-sm text-red-600 mt-1">{formErrors.itinerary}</p>
                )}
              </div>
                  ...
                  {form.images.map((img, idx) => (
                    ...
                    >
                      ...
                      <div className="absolute left-0 bottom-0 flex gap-1">
                        {idx > 0 && (
                          <button
                            className="text-xs bg-black/50 text-white px-1"
                            onClick={() => {
                              setForm((prev) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                <div className="grid gap-2">
                  ...
                  {formErrors.destination && (
                    <p className="text-sm text-red-600 mt-1">{formErrors.destination}</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  {formErrors.discountPrice && (
                    <p className="text-sm text-red-600 mt-1">{formErrors.discountPrice}</p>
                  )}
                </div>
                <div className="grid gap-2">
                  ...
                  {formErrors.durationDays && (
                    <p className="text-sm text-red-600 mt-1">{formErrors.durationDays}</p>
                  )}
                </div>
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((prev) => ({ ...prev, durationNights: e.target.value }))
                    }
                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                  />
                  {formErrors.durationNights && (
                    <p className="text-sm text-red-600 mt-1">{formErrors.durationNights}</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setForm((prev) => ({ ...prev, groupSizeMin: e.target.value }))}
                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                  />
                  {formErrors.groupSizeMin && (
                    <p className="text-sm text-red-600 mt-1">{formErrors.groupSizeMin}</p>
                  )}
                </div>
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setForm((prev) => ({ ...prev, groupSizeMax: e.target.value }))}
                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                  />
                  {formErrors.groupSizeMax && (
                    <p className="text-sm text-red-600 mt-1">{formErrors.groupSizeMax}</p>
                  )}
                </div>
              </div>
