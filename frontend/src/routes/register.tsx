    ...
    <div className="min-h-screen pt-32 pb-16 flex items-center justify-center">
      <div className="w-full max-w-md px-4">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold tracking-tight text-foreground mb-2">Join Us</h1>
          <p className="text-muted-foreground">Create your Nomads Navigate Nepal account</p>
        </div>
