...
module.exports = createModel('ItineraryDay', {
  defaults: { subtitle: '', altitude: '', meals: '', accommodation: '', hours: '', distance: '', coverImage: '', gallery: [], checklist: [], description: '', notes: '', tips: '', sortOrder: 0 },
  validate: async (doc) => {
    ...
    if (!Array.isArray(doc.gallery) || !Array.isArray(doc.checklist)) throw new AppError('Gallery and checklist must be arrays', 400);
  },
});
