  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-20">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
        <div>
          <p className="text-sm font-medium text-accent uppercase tracking-wider">Featured journeys</p>
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24">
      <div className="max-w-2xl mb-12">
        <p className="text-sm font-medium text-accent uppercase tracking-wider">Travellers' tales</p>
        <h2 className="mt-2 text-4xl md:text-5xl font-semibold tracking-tight">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-aurora p-10 md:p-16 shadow-elegant">
        ...
        <div className="relative max-w-2xl text-white">
          ...
          <p className="mt-4 text-white/85 text-lg">
            Tell us your dates and dream peak — we'll come back within 24 hours with a tailor-made plan.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              to="/contact"
